        ...
        <FormItem>
          {getFieldDecorator('userName')(
            <Row type="flex" justify="space-around">
              ...
              <Col xs={24} md={5}><Button type="primary" loading={this.props.loading} onClick={()=>{this.props.handleButtonAction(this.props.agentes,this.props.ordenes)}} style={{width:"100%"}}><Icon type={this.props.modo===1?"pie-chart":"profile"} />{this.props.modo===1?"Distribuir":"Cargar"}</Button></Col>
            </Row>
          )}
        </FormItem>
      </Form>
